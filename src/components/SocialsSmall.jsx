...
const SocialsLarge = () => {
    return (
        <>
            <ul>
                <li className='w-40 h-14 pl-4 pr-2 pt-3 duration-300 bg-gray-500 text-white'>
                ...
                <li className='flex justify-start items-center w-40 h-14 pl-4 pr-2 duration-300 bg-gray-500 text-white'>
